                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon, label }, key) => (
                            <a key={key} href={href} target="_blank" className="w-20 h-20 flex flex-col items-center justify-center gap-1 ring-inset ring-2 ring-zinc-50/50 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up">
