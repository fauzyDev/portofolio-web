...
const CertificateCard = ({ name, imgSrc }) => {
    return (
        <div className="bg-zinc-800 p-5 rounded-xl min-w-[320px] flex flex-col grid-cols-1 lg:min-w-[420px]">
            <div className="flex flex-col items-center gap-2 mt-auto">
                ...
                <div>
                    <p className="text-center font-semibold text-zinc-200 mt-2">{name}</p>
                </div>
            </div>
        </div>
    );
