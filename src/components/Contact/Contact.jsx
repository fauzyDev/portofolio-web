...
const socialLinks = [
    ...
    },
    {
      ...
      icon: <svg width="28" height="28" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon, label }, key) => (
                            <a key={key} href={href} rel="noopener noreferrer" target="_blank" className="w-20 h-20 flex flex-col items-center justify-center gap-1 ring-inset ring-2 ring-zinc-50/50 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up">
                ...
                <form action="" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" name="email" id="email" autoComplete="example@gmail.com" required placeholder="Email" className="text-field reveal-up" />
                        </div>
                    </div>
                    <div className="mb-4">
